...
namespace Dietary.DataAccess.Migrations
{
    ...
    [Migration("20240327070111_mapFatSecretFood")]
    partial class mapFatSecretFood
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dietary.DataAccess.Entities.Food", b =>
                {
                    ...
                    b.Property<Guid>("IdFatSecret")
                        .HasColumnType("uuid")
                        .HasColumnName("id_fat_secret");
                    ...
                    b.HasIndex("IdFatSecret")
                        .IsUnique()
                        .HasDatabaseName("ix_food_id_fat_secret");
            ...
            modelBuilder.Entity("Dietary.DataAccess.Entities.Food", b =>
                {
                    b.HasOne("Dietary.DataAccess.Entities.FatSecretFood", "FatSecretData")
                        .WithOne("Food")
                        .HasForeignKey("Dietary.DataAccess.Entities.Food", "IdFatSecret")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_food_fat_secret_food_id_fat_secret");

                    b.Navigation("FatSecretData");
                });
